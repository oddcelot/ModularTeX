...
\usepackage[super, comma, numbers, square, sort]{natbib} % use citations and generate cition list in the style of Nature journal
...
\usepackage{float}	% let user determine floating position of fig, equation, table, etc. (only use if neccessary, since latex does a good job on ints own)
